    ...
    return (<Center w='full' h='auto' bg={'gray.100'}>
        <Container maxW={'6xl'} h='80%' pt='100px'>
            <VStack >
                ...
                <Grid h={'auto'} w="full" mt={'100px'} templateColumns={{base:"repeat(2,1fr)",sm:"repeat(2,1fr)",md:"repeat(3,1fr)",lg:"repeat(4,1fr)",xl:"repeat(4,1fr)"}} justifyContent={{base:"space-between",sm:"space-around",md:"space-between",lg:"",xl:""
            }}>
                    <GridItem>
                        <VStack sx={styles}>
