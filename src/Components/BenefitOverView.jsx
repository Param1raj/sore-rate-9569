...
export default function Benefits() {
    return (<Center w={'full'} h='fit-content' pt={{base:'30px',sm:"30px",md:"50px",lg:"70px",xl:"100px"}} mb={{base:'30px',sm:"30px",md:'50px',lg:"70px",xl:"100px"}} border={1}>
        <Container maxW={'5xl'} h='85%' display='flex' alignItems='flexStart' >
            <VStack spacing={4} w='full' display='flex' alignItems='flexStart' >
                ...
                <Grid templateColumns={{base:'repeat(2,1fr)',sm:"repeat(2,1fr)",md:"repeat(2,1fr)",lg:"repeat(3,1fr)",xl:"repeat(3,1fr)"}} gap='10px' mb={54}>
